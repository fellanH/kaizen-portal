    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-8">
          ...
          <p
            className="text-sm tracking-[0.08em] uppercase text-foreground/50"
    ...
    return (
      ...
      >
        <div className="flex w-full max-w-[480px] flex-col items-start">
          ...
          <h1
            className="kaizen-enter-2 text-[clamp(2rem,1.14vw+1.72rem,3rem)] font-light leading-[1.1] tracking-[-0.03em] text-foreground"
          >
